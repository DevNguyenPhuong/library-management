...
export default function UpdateCurrentLibrarianForm() {
  ...
  const {
    ...
    queryFn: () => getAllData(`/librarians/my-info`),
    queryKey: ["current-librarian"],
  });

  const { mutate, isPending } = useMutation({
    mutationFn: (userData) => {
      return user?.id
        ? updateData(`/librarians/update-me`, userData)
        : createData("/librarians", userData);
    },
