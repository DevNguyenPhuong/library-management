...
const LibraryUtilization = ({ totalBooks, borrowedBooks, overdueBooks, activePatrons, totalPatrons, statusQueryBook, statusQueryPatron }) => {
              ...
              statusQueryPatron?.error ? (
                ...
                : (
                  <>
                    ...
                    />
                    <Progress
                      percent={((activePatrons / totalPatrons) * 100).toFixed(2)}
                      strokeColor="#FFA07A"
                    />
                  </>
                )
